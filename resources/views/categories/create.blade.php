       ...
       {{-- error handling messages on top of the page --}}
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="sm-shadow card p-5 m-3">
                <form action="{{ route('categories.store') }}" class="form-control" method="post">
                    @csrf

                    <div class="mb-3">
                        <label for="name" class="form-label">Name</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Name" @error('name') is-invalid @enderror value="{{ old('name')}}">
